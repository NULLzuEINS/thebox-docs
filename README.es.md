...
El**Entrega de llaves**discutimos individualmente.**Lecho**puedes dejarlo encendido. El**Lavar** und den **Basura**Yo también lo hago.
...
¡Que tengas una buena estancia en Leipzig!
andré
...
?> El documento original fue escrito en[Inglés](README.md). La traducción fue realizada con Google Translate. Si encuentra algún error, intente ignorarlo. ¡Gracias!
