...
| ![Lichter](_media/remotes/remote-ceiling.png ":size=100") | **اس سے پہلے کہ آپ اسے استعمال کر سکیں، یقینی بنائیں کہ داخلی دروازے پر لائٹ کا سوئچ "آن" پر سیٹ ہے۔**<br>پہلی لائن: چمک، آن/آف<br>Farbige Tasten: Hiermit kannst Du die Farben wechseln<br>گرے بٹن: مختلف اثرات کے درمیان سوئچ کریں۔ |
