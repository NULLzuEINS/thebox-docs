...
!\[[активи/wlan.png|400]щ

## Кімнати

!\[[активи/thebox-map-detail.png]щ
...
Якщо у вас виникли запитання або потрібна підтримка, я з радістю вам допоможу. Якщо ви поспішаєте, то найкраще це зробити по телефону`+49 170 73 53 067`. Ви також можете використовувати попередньо встановлену програму обміну повідомленнями з обмеженою функціональністю (SMS). Інакше у мене в коридорі є блокнот і ручка.

Приємного перебування в Лейпцигу!
Андре
