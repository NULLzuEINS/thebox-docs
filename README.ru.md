...
| ![Lichter](_media/remotes/remote-ceiling.png ":size=100") | **Прежде чем использовать его, убедитесь, что выключатель света на входе включен.**<br>Первая строка: яркость, вкл/выкл<br>Цветные кнопки: вы можете использовать их для изменения цвета.<br>Серые кнопки: переключение между различными эффектами. |
...
1.  Свет не загорается и не мигает. Используйте небольшой пульт дистанционного управления с разноцветными кнопками.
