...
С[Приложение Лейпциг MOVE](https://leipzig-move.de/), вы получаете 10 бесплатных поездок по 15 минут каждая за_Nextbikes_. Обратите внимание, что если вы не паркуете велосипеды на главных улицах (фиолетовый цвет на карте), это будет стоить дороже. Электросамокаты можно парковать только на определенных парковочных местах. Существует также система совместного использования автомобилей в свободном обращении. Это значит, что с нами[Ситифлитцер](https://cityflitzer.de/). Und gibt es natürlich noch Bus und Bahn welche Du ebenfalls über die Leipzig MOVE App bezahlen könnte.
