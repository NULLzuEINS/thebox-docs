...
| ![Lichter](_media/remotes/remote-ceiling.png ":size=100") | **ご使用前に玄関の照明スイッチが「入」になっていることをご確認ください。**<br>1行目：明るさ、オン/オフ<br>Farbige Tasten: Hiermit kannst Du die Farben wechseln<br>灰色のボタン: さまざまな効果を切り替えます |
