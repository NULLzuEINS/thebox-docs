...
私のゲストの中には1ヶ月以上滞在する人もいます。あなたもその一人であれば、このセクションはあなたのためのものです!

## 洗濯機

事前に連絡しなくても洗濯機を使用できます。乾燥ラック、洗剤、柔軟剤も使用できます。
...
旅行ガイドを AirBnB アプリに保存しました。そこでは、観光スポット、エンターテイメント、レストランに関する私のおすすめが見つかります。
