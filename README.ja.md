...
1.  ライトが点灯しないか、激しく点滅します。カラフルなボタンが付いた小さなリモコンを使用してください。
...
すべてのフックにタオルを掛けて、どこにでも物を置くことができます。トイレのドアの前に棚があります。そのうちの 1 つはあなたのものです。
...
とともに[ライプツィヒ MOVE アプリ](https://leipzig-move.de/)、それぞれ 15 分間の乗車が 10 回無料になります。_ネクストバイク_。
