...
| ![Lichter](_media/remotes/remote-imac.png ":size=100")    | Αυτό είναι το τηλεχειριστήριο για τον υπολογιστή (iMac)._Damit Du den Computer verwenden kannst, drücke die Taste A auf der ersten Fernbedienung. Sie aktiviert die Stromzufuhr für den Computer und die Bluetooth-Box._                                                                                        |
