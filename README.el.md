...
Η θερμοκρασία και η υγρασία μετρώνται αυτόματα μέσω των αισθητήρων. Τα χρησιμοποιώ για να αποτρέψω το σχηματισμό μούχλας. Είναι μικρά και λευκά και συνήθως βρίσκονται στα κουφώματα της πόρτας. Μπορείτε να χρησιμοποιήσετε μέρος των δεδομένων μέτρησης
Σε διαβάζω στον καθρέφτη στο διάδρομο.
