...
Υπάρχουν βοηθοί φωνής Alexa στο διαμέρισμα. Μπορείτε να τους απευθυνθείτε με το όνομα «Υπολογιστής» και να τους βάλετε να παίξουν την Deutschlandfunk Nova, για παράδειγμα. Οι συσκευές είναι συνδεδεμένες στο Internet και μπορούν επίσης να χρησιμοποιηθούν ως ξυπνητήρια ή χρονόμετρα. Εάν δεν θέλετε να το χρησιμοποιήσετε, μπορείτε απλά να το αποσυνδέσετε από το τροφοδοτικό.
...
Με την[Εφαρμογή Leipzig MOVE](https://leipzig-move.de/), λαμβάνετε 10 δωρεάν βόλτες των 15 λεπτών η καθεμία για αυτούς_Nextbikes_. Σημειώστε ότι κοστίζει περισσότερο αν δεν παρκάρετε τα ποδήλατά σας στους κεντρικούς δρόμους (μωβ στον χάρτη). Τα ηλεκτρονικά σκούτερ επιτρέπεται να σταθμεύουν μόνο σε ορισμένες θέσεις στάθμευσης. Υπάρχει επίσης ένα δωρεάν σύστημα κοινής χρήσης αυτοκινήτου. Αυτό σημαίνει μαζί μας[cityflitzer](https://cityflitzer.de/). Και φυσικά υπάρχουν επίσης λεωφορεία και τρένα που θα μπορούσατε επίσης να πληρώσετε μέσω της εφαρμογής Leipzig MOVE.
...
Μπορείτε να χρησιμοποιήσετε το πλυντήριο χωρίς να χρειαστεί να ρωτήσετε πρώτα. Μπορείτε επίσης να χρησιμοποιήσετε τη σχάρα στεγνώματος, τη σκόνη πλυσίματος και το μαλακτικό υφασμάτων.

## Βούρτσα χειρός και σκόνη
...
Έχω αποθηκεύσει ταξιδιωτικούς οδηγούς στην εφαρμογή AirBnB. Εκεί θα βρείτε τις προτάσεις μου για αξιοθέατα, διασκέδαση και εστιατόρια.
