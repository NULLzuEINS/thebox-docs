...
Με την[Leipzig MOVE App](https://leipzig-move.de/), λαμβάνετε 10 δωρεάν διαδρομές των 15 λεπτών η καθεμία για το_Nextbikes_. Σημειώστε ότι κοστίζει περισσότερο αν δεν παρκάρετε τα ποδήλατά σας στους κεντρικούς δρόμους (μωβ στον χάρτη). Τα ηλεκτρονικά σκούτερ επιτρέπεται να σταθμεύουν μόνο σε ορισμένες θέσεις στάθμευσης. Υπάρχει επίσης ένα δωρεάν σύστημα κοινής χρήσης αυτοκινήτου. Αυτό σημαίνει μαζί μας[cityflitzer](https://cityflitzer.de/). Und gibt es natürlich noch Bus und Bahn welche Du ebenfalls über die Leipzig MOVE App bezahlen könnte.
